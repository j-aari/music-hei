...
| `coverage.json` | Uncovered areas (no institution within 300 km, and none in the same country within 600 km), calculated from the coordinates (0.1° grid), with per-country shares. Areas with no institution within 300 km but one in the same country within 600 km are listed separately and not counted |
